...
<head>
  ...
  <title>nedv — недвижимостьа в Москве от итальянского повара</title>
  <?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
...
<header class="header-page">
  <div class="container header-page__container">
    ...
    <div class="header-page__end">
      ...
      <div class="phone">
        <a class="phone__item header-page__phone" href="tel:<?php echo $GLOBALS['nedvig']['phone_digits']; ?>"><?php echo $GLOBALS['nedvig']['phone']; ?></a>
      </div>
