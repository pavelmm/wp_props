    ...
    <div class="popup__inner">
      <div class="popup__content popup__content--fluid popup__content--centered">
        ...
        <div class="phone popup__phone">
          <a class="phone__item phone__item--accent" href="tel:<?php echo $GLOBALS['nedvig']['phone_digits']; ?>"><?php echo $GLOBALS['nedvig']['phone']; ?></a>
        </div>
        <ul class="socials">
          <?php if ($GLOBALS['nedvig']['vk_url']) : ?>
            <li class="socials__item">
              <a href="<?php echo $GLOBALS['nedvig']['vk_url']; ?>" class="socials__link" target="_blank">
          ...
          <?php if ($GLOBALS['nedvig']['fb_url']) : ?>
            <li class="socials__item">
              <a href="<?php echo $GLOBALS['nedvig']['fb_url']; ?>" class="socials__link" target="_blank">
          ...
          <?php if ($GLOBALS['nedvig']['inst_url']) : ?>
            <li class="socials__item">
              <a href="<?php echo $GLOBALS['nedvig']['inst_url']; ?>" class="socials__link" target="_blank">
  ...
  <div class="popup__wrapper">
    <div class="popup__inner">
      <div class="popup__content">
        ...
        <p class="popup__subtitle popup__subtitle--order">Мы скоро вам ответим</p>
        <div class="order">
          ...
          <form class="form form-send">
            <input class="order-info-title" type="hidden" name="недвижимостьа">
  ...
  <div class="popup__wrapper">
    <div class="popup__inner">
      <div class="popup__content">
        ...
        <p class="popup__subtitle">Мы уже вам звоним</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="popup__wrapper">
    <div class="popup__inner">
      <div class="popup__content">
        ...
        <p class="popup__subtitle">Пожалуйста, позвоните по номеру <a class="popup__link" href="<?php echo $GLOBALS['nedvig']['phone_digits']; ?>"><?php echo $GLOBALS['nedvig']['phone']; ?></a></p>
      </div>
    </div>
  </div>
</div>
