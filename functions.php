...
function cptui_register_my_taxes() {
	...
	$labels = [
		"name" => __( "Офисы", "custom-post-type-ui" ),
		"singular_name" => __( "Офис", "custom-post-type-ui" ),
	];

	$args = [
		"label" => __( "Офисы", "custom-post-type-ui" ),
		"labels" => $labels,
		"public" => true,
		...
		"query_var" => true,
		"rewrite" => [ 'slug' => 'ofice', 'with_front' => true, ],
	...
	register_taxonomy( "ofice", [ "nedv" ], $args );
}
