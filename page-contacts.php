  ...
  <div class="container section-contacts__container">
    ...
    <div class="contacts">
      <div class="contacts__start">
        <div class="contacts__map" id="ymap" data-coordinates="<?php echo $GLOBALS['nedvig']['map_coordinates']; ?>" data-address="<?php echo $GLOBALS['nedvig']['address']; ?>"></div>
      </div>
      <div class="contacts__end">
        
        <?php if ($GLOBALS['nedvig']['address']) : ?>
          <div class="contacts__item">
            <h3 class="contacts__title">Адрес</h3>
            <p class="contacts__text"><?php echo $GLOBALS['nedvig']['address']; ?></p>
          </div>
        <?php endif; ?>
        ...
        <div class="contacts__item">
          ...
          <p class="contacts__text">
            <a class="contacts__phone" href="tel:<?php echo $GLOBALS['nedvig']['phone_digits']; ?>"><?php echo $GLOBALS['nedvig']['phone']; ?></a>
          </p>
        </div>
        <div class="contacts__item">
